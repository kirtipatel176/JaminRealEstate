...
const Contact = () => {
  ...
  return (
    <div className="bg-bg-main min-h-screen pt-32 pb-20 relative overflow-hidden">
            ...
            <form className="flex flex-col gap-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <input type="tel" className="w-full bg-bg-main border border-border rounded-xl px-4 py-4 focus:outline-none focus:border-accent transition-colors" placeholder="+91 98765 43210" />
                </div>
              </div>
                ...
                <div className="flex flex-col gap-6">
                  <div className="flex items-center gap-4 group">
                    ...
                    <div>
                      ...
                      <p className="font-light tracking-wider">+91 98765 43210</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 group">
                    <div className="w-12 h-12 rounded-full border border-white/20 flex items-center justify-center group-hover:border-accent transition-colors">
                    ...
                    <div>
                      ...
                      <p className="font-light tracking-wider">invest@onlyjamin.com</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 group">
                    <div className="w-12 h-12 rounded-full border border-white/20 flex items-center justify-center group-hover:border-accent transition-colors">
                    ...
                    <div>
                      ...
                      <p className="font-light text-sm">101 Luxury Avenue, SG Highway,<br/>Ahmedabad, Gujarat 380015</p>
                    </div>
                  </div>
                </div>
              </div>
